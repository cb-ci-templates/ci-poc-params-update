...
* in both Examples, you MUST adjust your folder name, controller url and path to the init job, f.e. 
  *  https://"+ cred.getSecret().getPlainText() + "@example.com/sb/job/ci-templates-demo/job/DEMO-ParameterUsage/job/initData/lastSuccessfulBuild/artifact/newparams.txt/*view*/
